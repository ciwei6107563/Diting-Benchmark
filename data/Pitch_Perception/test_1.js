...
async function sendUserMessage(text) {
    ...
    ws.send(JSON.stringify({type: 'response.create',response: {
        ...
        instructions: "In the following audio segment, into which range does more than 70% of the fundamental frequency content fall? Please choose from the following two ranges: (80, 150) Hz and (180, 250) Hz.",
    }}));
...
processJsonFile('C:\\Users\\23225\\PycharmProjects\\SpeechDataPreprocess\\gpt4O_all\\Pitch_Perception\\Q_F0_Detective_filter.json');
