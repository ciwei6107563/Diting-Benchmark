...
out_dir = "~/speech_wav/CoughSegmentationData"
os.makedirs(out_dir, exist_ok=True)
json_out_dir = "~/speech_wav/CoughSegmentationData"
...
# 指定文件夹路径
folder_path = '~/speech_wav/CoughSegmentationData/virufy-data/clinical/segment'  # 请将这里的路径替换为您的文件夹路径
# 遍历文件夹中的所有文件
all_list = list()
