...
async function sendUserMessage(text) {
    ...
    ws.send(JSON.stringify({type: 'response.create',response: {
        ...
        instructions: "Is there singing in this audio clip?Please answer by yes or no.",
    }}));
...
processJsonFile('C:\\Users\\23225\\PycharmProjects\\SpeechDataPreprocess\\gpt4O_all\\Singing_Detection\\Q_Is_singing_filter.json');
